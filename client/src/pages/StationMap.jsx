        ...
        {isNavigating ? (
          <div>
            ...
            <p style={{ margin: "5px 0" }}>
              <strong>Remaining:</strong> ~{Math.round(remainingDistance)}{" "}
              meters
            </p>
            <p style={{ margin: "5px 0" }}>
              <strong>Time:</strong> ~
          ...
          <p className="dark:text-black">Select a route to begin navigation</p>
        )}
      </div>
              ...
              {trains.map((train) => (
                <tr key={train.id} style={{ borderBottom: "1px solid #eee" }}>
                  ...
                  <td
                    style={{
                      padding: "12px",
                      color: train.status.includes("Delayed")
                        ? "#dc3545"
                        : "#28a745",
                    }}
                  >
        ...
        <nav style={{ display: "flex", gap: "10px" }}>
          <button
            ...
            style={{
              padding: "8px 16px",
              backgroundColor:
                currentView === "map" ? "#003d7a" : "transparent",
              color: "white",
              border: "none",
              borderRadius: "5px",
              cursor: "pointer",
          ...
          <button
            ...
            style={{
              padding: "8px 16px",
              backgroundColor:
                currentView === "trains" ? "#003d7a" : "transparent",
              color: "white",
              border: "none",
              borderRadius: "5px",
              cursor: "pointer",
          ...
          <button
            ...
            style={{
              padding: "8px 16px",
              backgroundColor:
                currentView === "navigate" ? "#003d7a" : "transparent",
              color: "white",
              border: "none",
              borderRadius: "5px",
              cursor: "pointer",
